      ...
      <div className="flex flex-1 max-w-[1200px] mx-auto w-full md:px-margin-desktop md:py-margin-desktop">
        ...
        <aside className="bg-surface-container-low h-full w-80 left-0 border-r border-outline flex flex-col sticky top-0 hidden md:flex mr-gutter">
          ...
          <nav className="flex flex-col p-4 gap-2 flex-1">
            ...
            <Link className="flex items-center gap-3 px-4 py-3 rounded text-on-surface-variant hover:bg-surface-container-high transition-colors duration-200" href="/dashboard/cards">
              <span className="material-symbols-outlined">credit_card</span>
              <span className="font-body-md text-body-md">Credit Cards</span>
            </Link>
            <Link className="flex items-center gap-3 px-4 py-3 rounded text-on-surface-variant hover:bg-surface-container-high transition-colors duration-200" href="/dashboard/loans">
            ...
            <Link className="flex items-center gap-3 px-4 py-3 rounded text-on-surface-variant hover:bg-surface-container-high transition-colors duration-200" href="/dashboard/transfer">
              <span className="material-symbols-outlined">swap_horiz</span>
              <span className="font-body-md text-body-md">Transfers</span>
            </Link>
            <Link className="flex items-center gap-3 px-4 py-3 rounded text-on-surface-variant hover:bg-surface-container-high transition-colors duration-200" href="/dashboard/deposit">
        ...
        <main className="flex-1 w-full flex flex-col gap-md px-margin-mobile md:px-0 mt-6 md:mt-0">
          <div className="border-b border-surface-dim pb-sm">
            <h2 className="font-headline-lg text-headline-lg text-on-surface">Transaction History</h2>
            <p className="font-body-md text-body-md text-on-surface-variant mt-xs">
              {selectedAccount ? `${selectedAccount.accountName} (${selectedAccount.accountNumber})` : "Aggregated Transaction History"}
            </p>
          </div>
